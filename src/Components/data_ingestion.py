...
class DataIngestionConfig:
    # path for train, test and raw data
...
class DataIngestion:
    def __init__(self) -> None:
        # Creating DataIngestionConfig object
        # It will contain all three variables
...
if __name__=="__main__":
    ...
    model_name,r2_score=modelTrainer.initiate_model_training(train_arr, test_arr)
    print(model_name)
    print(r2_score)
